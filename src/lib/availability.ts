/**
 * Availability checking utilities for the hotel booking system
...
/**
 * Checks availability of a property for a given date range
...
export async function checkAvailabilityClient(
  ...
  // This will be called from client components via an API route or server action
