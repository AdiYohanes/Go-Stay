 ...
 * Displays success animation and booking confirmation
      ...
      <div className="text-center space-y-6">
        ...
        <div className="bg-muted p-4 rounded-lg text-sm text-left space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          ...
          <ul className="space-y-1 text-muted-foreground">
            ...
            <li>✓ The property host will be notified of your reservation</li>
            <li>✓ You&apos;ll receive a reminder before your check-in date</li>
          </ul>
        </div>
