        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm md:text-base text-muted-foreground font-medium">
            <div className="flex items-center gap-1">
              ...
              <span className="underline decoration-muted-foreground/40 hidden sm:inline">
                · 128 reviews
              </span>
            </div>
            ...
            <div className="pb-6 border-b border-border">
              ...
              <div className="text-muted-foreground leading-relaxed text-base md:text-lg space-y-4">
                ...
                <p>
                  ...
                  Modern amenities, comfortable furnishings, and a prime
                  location make this the perfect home base for your next
                  adventure.
                </p>
              </div>
            </div>
            ...
            <div className="pb-6">
              ...
              <div className="mt-4 space-y-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We’ll send you the exact location once your booking is
                  confirmed. The area is known for its stunning desert
                  landscapes and clear night skies, perfect for stargazing.
                </p>
