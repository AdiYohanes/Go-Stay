-- Script untuk menghapus data lama dan insert data resort Bali
-- Jalankan di Supabase SQL Editor

-- STEP 1: Hapus semua data properties yang ada
TRUNCATE TABLE properties CASCADE;

-- STEP 2: Reset sequence ID (opsional)
-- ALTER SEQUENCE properties_id_seq RESTART WITH 1;

-- STEP 3: Insert data resort Bali
-- Note: Hanya menggunakan kolom yang pasti ada di database
INSERT INTO properties (
  id, title, description, price_per_night, location,
  image_urls, amenities, max_guests, bedrooms, beds, bathrooms, is_active
) VALUES
...
-- 3. W Bali Seminyak
('bali-w-seminyak', 'W Bali Seminyak',
...
-- 4. The St. Regis Bali
('bali-stregis-nusadua', 'The St. Regis Bali Resort',
...
-- 5. COMO Uma Canggu
('bali-como-canggu', 'COMO Uma Canggu',
...
('bali-padma-legian', 'Padma Resort Legian',
...
('bali-mandapa-ubud', 'Mandapa, a Ritz-Carlton Reserve',
...
('bali-sixsenses-uluwatu', 'Six Senses Uluwatu',
